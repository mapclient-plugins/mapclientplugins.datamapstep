...
class Ui_DataMapper(object):
    def setupUi(self, DataMapper):
        ...
        self.model_field_frame = QFrame(self.groupBox_4)
        self.model_field_frame.setObjectName(u"model_field_frame")
        self.model_field_frame.setFrameShape(QFrame.StyledPanel)
        self.model_field_frame.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_12 = QHBoxLayout(self.model_field_frame)
        self.horizontalLayout_12.setObjectName(u"horizontalLayout_12")
        self.horizontalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.model_field_label = QLabel(self.model_field_frame)
        self.model_field_label.setObjectName(u"model_field_label")
        self.model_field_label.setMaximumSize(QSize(160, 16777215))

        self.horizontalLayout_12.addWidget(self.model_field_label)

        self.model_field_comboBox = QComboBox(self.model_field_frame)
        self.model_field_comboBox.setObjectName(u"model_field_comboBox")

        self.horizontalLayout_12.addWidget(self.model_field_comboBox)


        self.verticalLayout_4.addWidget(self.model_field_frame)

        self.data_field_frame = QFrame(self.groupBox_4)
        self.data_field_frame.setObjectName(u"data_field_frame")
        self.data_field_frame.setFrameShape(QFrame.StyledPanel)
        self.data_field_frame.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_13 = QHBoxLayout(self.data_field_frame)
        self.horizontalLayout_13.setObjectName(u"horizontalLayout_13")
        self.horizontalLayout_13.setContentsMargins(0, 0, 0, 0)
        self.data_field_label = QLabel(self.data_field_frame)
        self.data_field_label.setObjectName(u"data_field_label")
        self.data_field_label.setMaximumSize(QSize(160, 16777215))

        self.horizontalLayout_13.addWidget(self.data_field_label)

        self.data_field_comboBox = QComboBox(self.data_field_frame)
        self.data_field_comboBox.setObjectName(u"data_field_comboBox")

        self.horizontalLayout_13.addWidget(self.data_field_comboBox)


        self.verticalLayout_4.addWidget(self.data_field_frame)
    ...
    def retranslateUi(self, DataMapper):
        ...
        self.groupBox_4.setTitle(QCoreApplication.translate("DataMapper", u"Field Chooser", None))
        self.model_field_label.setText(QCoreApplication.translate("DataMapper", u"Model Coordinates Field:", None))
        self.data_field_label.setText(QCoreApplication.translate("DataMapper", u"Data Coordinates Field:", None))
